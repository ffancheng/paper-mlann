...
makeKNNgraph <- function (x, k, eps = 0, annmethod = c("brute-force", "kdtree", "annoy", "hnsw"), radius = NULL, nt = 50, search.k = 500, nlinks = 16, ef.construction = 200, diag = FALSE, distance = c("euclidean", "manhattan"), ...){
