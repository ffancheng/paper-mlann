% !TeX document-id = {36a6fed6-b6ca-4567-a605-b3d40b7d1743}
...
{\centering \includegraphics[width=0.8\linewidth]{paper/figures/ann} 
...
{\centering \includegraphics[width=.49\linewidth]{paper/figures/annoy1} \includegraphics[width=.49\linewidth]{paper/figures/annoy2} 
...
{\centering \includegraphics[width=0.6\linewidth]{paper/figures/naive_search} 
...
{\centering \includegraphics[width=0.6\linewidth]{paper/figures/hnsw} 
...
{\centering \includegraphics[width=0.8\linewidth]{paper/mlann_jcgs_files/figure-latex/recall-1} 
...
{\centering \includegraphics[width=1\linewidth]{paper/mlann_jcgs_files/figure-latex/iso-1} 
...
{\centering \includegraphics[width=1\linewidth]{paper/mlann_jcgs_files/figure-latex/iso6measure-1} 
...
{\centering \includegraphics[width=1\linewidth]{paper/mlann_jcgs_files/figure-latex/hllemeasure-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{paper/figures/smartmeter} 
...
{\centering \includegraphics[width=1\linewidth]{paper/figures/knng20_1id336tow} 
...
{\centering \includegraphics[width=1\linewidth]{paper/figures/tod_compare_kdtreeannoy_1id336tow} 
...
{\centering \includegraphics[width=1\linewidth]{paper/figures/hdr10_compareisomap_kdtreeannoy_1id336tow} 
...
{\centering \includegraphics[width=1\linewidth]{paper/figures/electricity_compare2tow_1id336tow} 
...
{\centering \includegraphics[width=1\linewidth]{paper/figures/hdr10_compare4ml_kdtreeannoy_allids_nt50_3639id_notow_201length} 
...
{\centering \includegraphics[width=0.8\linewidth]{paper/figures/electricity_compare3id} 
...
{\centering \includegraphics[width=1\linewidth]{paper/figures/electricity_hdrbox_3id_7dow} 
