...
{\centering \includegraphics[width=0.8\linewidth]{/Users/fche0019/git/mlann_dev/paper/figures/ann} 
...
{\centering \includegraphics[width=.49\linewidth]{/Users/fche0019/git/mlann_dev/paper/figures/annoy1} \includegraphics[width=.49\linewidth]{/Users/fche0019/git/mlann_dev/paper/figures/annoy2} 
...
{\centering \includegraphics[width=0.5\linewidth]{/Users/fche0019/git/mlann_dev/paper/figures/naive_search} 
...
{\centering \includegraphics[width=0.45\linewidth]{/Users/fche0019/git/mlann_dev/paper/figures/hnsw} 
...
{\centering \includegraphics[width=0.8\linewidth]{/Users/fche0019/git/mlann_dev/paper/figures/smartmeter} 
...
{\centering \includegraphics[width=1\linewidth]{/Users/fche0019/git/mlann_dev/paper/figures/tod_compare_kdtreeannoy_6methods_1id_336tow_201length_transpose} 

}

\caption{Embeddings from six manifold learning methods (ISOMAP, LLE, Laplacian eigenmaps, Hessian LLE, t-SNE and UMAP) for one household from the smart meter data. Each subplot is a scatterplot of the 2-d embedding points, with the color representing half-hourly time of the day. Top-panel: exact nearest neighbors. Middle-panel: ANN with k-d trees. Bottom-panel: ANN with Annoy.}\label{fig:todplot}
\end{figure}

\begin{table}

\caption{\label{tab:quality1id}Comparison of Trustworthiness measure using true nearest neighbors, k-d trees and Annoy for six manifold learning methods in meter ID 1003. ISOMAP with Annoy gives the highest Trustworthiness. }
\centering
\resizebox{\linewidth}{!}{
...
\midrule
Exact NN & \textbf{0.983} & 0.821 & 0.937 & 0.964 & \textbf{0.973} & 0.976\\
ANN k-d trees & \textbf{0.983} & 0.813 & 0.937 & \textbf{0.966} & 0.962 & 0.975\\
ANN Annoy & \textbf{0.983} & \textbf{0.869} & \textbf{0.938} & 0.961 & 0.970 & \textbf{0.978}\\
\bottomrule
\end{tabu}}
\end{table}
...
\caption{\label{tab:time1id}Comparison of computation time using true nearest neighbors, k-d trees, and Annoy for six manifold learning methods in meter ID 1003. Generally, k-d trees implementations for both exact and approximate NN are faster than Annoy. }
\centering
\resizebox{\linewidth}{!}{
\begin{tabu} to \linewidth {>{\raggedright}X>{}r>{}r>{}r>{}r>{}r>{}r}
\toprule
  & Isomap & LLE & Laplacian Eigenmaps & Hessian LLE & t-SNE & UMAP\\
\midrule
Exact NN & \textbf{1.724} & 2.581 & \textbf{1.900} & 1.412 & 1.452 & 1.781\\
ANN k-d trees & 1.914 & \textbf{2.266} & \textbf{1.900} & \textbf{1.397} & \textbf{1.446} & \textbf{1.778}\\
ANN Annoy & 1.929 & 2.633 & 1.926 & 1.438 & 1.520 & 1.832\\
\bottomrule
\end{tabu}}
\end{table}
...
{\centering \includegraphics[width=1\linewidth]{/Users/fche0019/git/mlann_dev/paper/figures/hdr10_compareisomap_kdtreeannoy_1id336tow} 
...
{\centering \includegraphics[width=1\linewidth]{/Users/fche0019/git/mlann_dev/paper/figures/electricity_compare2tow_1id336tow} 
...
{\centering \includegraphics[width=1\linewidth]{/Users/fche0019/git/mlann_dev/paper/figures/hdr10_compare4ml_kdtreeannoy_allids_nt50_3639id_6methods_201length_transpose} 
...
\toprule
  & Isomap & LLE & Laplacian Eigenmaps & Hessian LLE & t-SNE & UMAP\\
\midrule
Exact NN & \textbf{0.985} & \textbf{0.952} & \textbf{0.966} & \textbf{0.948} & \textbf{0.975} & \textbf{0.987}\\
ANN k-d trees & \textbf{0.985} & 0.917 & 0.965 & 0.943 & \textbf{0.975} & \textbf{0.987}\\
ANN Annoy & \textbf{0.985} & \textbf{0.952} & \textbf{0.966} & 0.943 & \textbf{0.975} & 0.986\\
\bottomrule
\end{tabu}}
\end{table}
...
\toprule
  & Isomap & LLE & Laplacian Eigenmaps & Hessian LLE & t-SNE & UMAP\\
\midrule
Exact NN & \textbf{11.350} & 22.109 & 3.086 & 5.964 & 535.705 & 4.184\\
ANN k-d trees & 11.433 & \textbf{18.820} & \textbf{2.781} & 5.171 & \textbf{508.336} & \textbf{4.114}\\
ANN Annoy & 16.164 & 24.239 & 7.756 & \textbf{5.128} & 512.593 & 4.970\\
\bottomrule
\end{tabu}}
\end{table}
...
{\centering \includegraphics[width=0.8\linewidth]{/Users/fche0019/git/mlann_dev/paper/figures/electricity_compare3id} 
...
{\centering \includegraphics[width=1\linewidth]{/Users/fche0019/git/mlann_dev/paper/figures/electricity_hdrbox_3id_7dow} 
